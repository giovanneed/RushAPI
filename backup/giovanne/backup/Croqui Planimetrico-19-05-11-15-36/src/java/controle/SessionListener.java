...
public class SessionListener implements HttpSessionListener
{
    ...
    {
        HttpSession session = se.getSession();
        String outputpath = session.getServletContext().getRealPath("") + "\\" + session.getServletContext().getInitParameter("output_path") + "\\";
       ...
       // File dir = new File(session.getServletContext().getInitParameter("output_path") + session.getId());
         File dir = new File(outputpath + session.getId());
