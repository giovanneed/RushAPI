...
public class Croqui
{
	...
	/**
	 * Unico construtor que deve receber como par�metro uma conex�o
	 */
	...
	/**
	 * Funcao que gera o croqui da quadra, com todos os seus lotes e destacando alguns lotes,
	 ...
	 * @param p_PKsLotesADestacar Número de lote ctm dos lotes a destacar, mostrando edificações, iptu, ctm e numero imovel
	...
	public BufferedImage gerarCroquiTipo1(com.lowagie.text.Rectangle p_Tamanho,
		...
		v_ConsultaQuadra += " where g."+quadra_ctm_numero_da_quadra+" = " + p_PKQuadra;
                v_ConsultaQuadra += " and g.status_geometria = 'V'";
		...
		v_ConsultaLote += " AND ipt."+iptu_ctm_geo_numero_do_lote+" = l."+lote_ctm_numero_do_lote;
                v_ConsultaLote += " and q.status_geometria = 'V' and l.status_trabalho = 'OK' and l.tipo_fechamento = 'LOTE CTM'";
		...
		Statement v_Statement = m_Conexao.createStatement();
               ...
               // System.out.println(v_ConsultaLote);
		...
		while(v_ResultSet.next())
		{
			if (p_PKsLotesADestacar.contains(v_ResultSet.getString(OBJECTID)))
			{
				...
				v_ConsultaEdificacao += " where l."+lote_ctm_numero_do_lote+" = '" + v_ResultSet.getString(OBJECTID) + "'";
                                v_ConsultaEdificacao += " and l.status_trabalho = 'OK' and l.tipo_fechamento = 'LOTE CTM'";
		...
		v_ConsultaLoteNaoDestacar += " where q."+quadra_ctm_numero_da_quadra+" = " + p_PKQuadra;
                v_ConsultaLoteNaoDestacar += "  and q.status_geometria = 'V' and l.status_trabalho = 'OK' and l.tipo_fechamento = 'LOTE CTM'";
		v_ConsultaLoteNaoDestacar += " AND sdo_relate(l."+geometria_lote+", q."+geometria_quadra+", 'mask=anyinteract') = 'TRUE'";
		...
		escreverCabecalhoTipo1(v_BufferedImagem, v_Graficos, m_CorQuadra, m_CorLote, m_CorEdificacao, m_CorLoteIptu, m_CorLoteCtm, m_CorLoteEndereco, p_PKQuadra, p_NomeTabelaQuadraCtm, p_NomeTabelaBairroPopular, p_NomeTabelaIptuGeoCtm,geometria_bairro_popular, nome_bairro_popular,
	...
	/**
	 * Funcao que gera o croqui do lote com e comprimento e area
	 * @return Retorna o bufferedImage que representa o croqui
	 * @param p_Tamanho Tamanho da imagem a ser gerada(A4, A3, A2, LETTER, ...)
	 * @param p_PKLote N�mero Lote CTM do lote
	 * @param p_OwnerTabelaLoteCtm Indica o owner da tabela de lote
	 * @param p_OwnerIptuGeoCtm Indica o owner da tabela de iptu
	 * @param p_OwnerFuncaoGetDistancia Indica o owner da funcao que calcula a dist�ncia entre 2 pontos em metros
	 * @exception SQLException
	 */
	...
	/**
	 * Funcao que cria a imagem ja tranformada do croqui com as devidas margens
	...
	/**
	 * Procedimento que limpa dos todos membros do croqui para iniciar uma nova geracao de croqui
	 */
	 ...
	 * Procedimento que escreve um texto na imagem
	 * @param p_Graficos Grafico que sera gerada a imagem
	 * @param p_CorRetangulo Cor do retangulo a ser desenhado
	 * @param p_Preencher Colocar preenchimento no ret�ngulo
	 * @param p_RetanguloX Coordenada x inicial do ret�ngulo a ser desenhado
	 * @param p_RetanguloY Coordenada y inicial do ret�ngulo a ser desenhado
	 * @param p_TamanhoRetanguloX Largura do x
	 * @param p_TamanhoRetanguloY Largura do y
	 * @param p_Preencher Indica se e para preencher o retangulo ou se desenhar
	 */
	 ...
	 * @param p_CorImovel Cor do imovel
	 * @param p_PKQuadra Numero lote ctm da quadra
	...
	private void escreverCabecalhoTipo1(BufferedImage p_BufferedImage, Graphics2D p_Graficos,
		...
		//prrenche toda a area do cabecalho para em branco para que s� seja mostrado cabecalho
		p_Graficos.setPaint(Color.WHITE);
		p_Graficos.fill(v_Retangulo);


                //System.out.println(p_PKQuadra + " | " + p_NomeTabelaQuadra+ " | " + p_NomeTabelaBairroPopular+ " | " +geometria_bairro_popular+ " | " +nome_bairro_popular+ " | " + geometria_quadra+ " | " +quadra_ctm_numero_da_quadra);
		...
		escreverTexto(p_Graficos, Color.BLACK, "CTM - Setor: " + v_CtmSetor.substring(0, 2), 200, 90);
                ...
                escreverTexto(p_Graficos, Color.BLACK, "Quadra: " + v_CtmSetor.substring(2, 5), 200, 120);
	...
	/**
	 * Procedimento que escreve o retangulo a moldura da legenda
	 * @param p_BufferedImage Encapsula a imagem a ser gerada
	 * @param p_Graficos Gráfico que será gerada a imagem
	...
	/**
	 * Funcao que retorna o nome do bairro que contem a quadra
	 * @return Retorna o nome do bairro que contem a quadra
	 * @param p_PKQuadra Numero de lote ctm da quadra
	 * @param p_Graficos Grafico que sera gerada a imagem
	...
	private String getNomeBairroDaQuadra(int p_PKQuadra, String p_NomeTabelaQuadra,
		...
		v_Consulta += " where q."+quadra_ctm_numero_da_quadra+" = " + p_PKQuadra;
                v_Consulta += " and q.status_geometria = 'V'";
		v_Consulta += " AND SDO_relate(b."+geometria_bairro_popular+",SDO_GEOM.SDO_CENTROID(q."+geometria_quadra+", .5),'MASK=CONTAINS+COVERS') = 'TRUE'";
                v_Consulta += " AND SDO_FILTER(q."+geometria_quadra+", b."+geometria_bairro_popular+") = 'TRUE'";
	...
	/**
	 * Funcao que retorna o indice cadastral da quadra
	...
	/**
	 * Funcao que retorna as cores possiveis do logradouro
	...
	private void preencherLogradouro(BufferedImage p_BufferedImagem, Graphics2D p_Graficos, int p_AlturaUtilizada,
		...
		Statement v_Statement = m_Conexao.createStatement();
                ...
                //Long horaInicial = System.currentTimeMillis();
                //System.out.println(v_ConsultaMapeamentoDeCores);
		...
		while(v_ResultSet.next())
		{
            ...
            preencherGeometriaLinha(p_BufferedImagem, p_Graficos, p_AlturaUtilizada, v_Cor, v_NovaConsulta, p_DesvioParaCaberElementosAoRedor);
	...
	/**
	 * Procedimento que gera o mapeamento de cores fazendo com que cada logradouro tenha sua propria cor
	 * @param p_BufferedImage Encapsula a imagem a ser gerada
	 * @param p_Graficos Grafico que será gerada a imagem
	 * @param p_AlturaUtilizada Desvio da altura que se deve considerar para desenhar o croqui
	 * @param p_Consulta Consulta a ser feita para encontrar os logradouros
	 * @exception SQLException
	 */
	 ...
	 * @param p_CorDivisaoSegmentos Cor do ponto que mostra a divisao entre os segmentos
		...
		while(v_ResultSet.next())
		{
			...
			if (!"".equals(p_NomeTabelaParaMostrarAreaEComprimento) && p_NomeTabelaParaMostrarAreaEComprimento != null)
			{
				...
				for(int c_Coordenada = 2; c_Coordenada < v_CoordenadasOriginal.length; c_Coordenada = c_Coordenada + 2)
				{
					...
					Statement v_StatementCalculoDistancia = m_Conexao.createStatement();
                                        ...
                                        //System.out.println(v_ConsultaCalculoDistancia);
			...
			if (p_CorValores != null)
			{
				...
				v_CoordenadasCentroid[1] = getCoordenadaY(p_BufferedImagem, v_CoordenadasCentroid[1], p_DesvioAlturaUtilizada);
                                ...
                                //array out of bounds aki sem a clausula c_Valor < v_Valores.length
				for(int c_Valor = 0; c_Valor < p_CorValores.length && c_Valor < v_Valores.length; c_Valor ++)
				{
    ...
    private void preencherGeometriaLinha(BufferedImage p_BufferedImagem, Graphics2D p_Graficos, int p_DesvioAlturaUtilizada,
            Color p_CorMoldura, String p_Consulta, double p_DesvioParaCaberElementosAoRedor
            ) throws SQLException {
	 ...
	 * @param p_ConverterPontos Indica se eh para converter o ponto de UTM para o valor do croqui ou se nao converte
	 * @exception SQLException
	 */
	...
	/**
	 * Funcao que retorna o tamanho(Altura e Largura) da area para desenhar o croqui
	 * @param p_BufferedImage Encapsula a imagem a ser gerada
	...
	/**
	 * Funcao que retorna a diferenca maior entre o X e entre o Y
	 * @param p_BufferedImage Encapsula a imagem a ser gerada
	 */
	...
	/**
	 * Funcao que converte a coordenada x
	 * @param p_BufferedImage Encapsula a imagem a ser gerada
	...
	/**
	 * Funcao que converte a coordenada y
	 * @param p_BufferedImage Encapsula a imagem a ser gerada
	 * @param p_CoordenadaOriginal Coordenada original a ser convertida
	...
	/**
	 * Procedimento que defini as menores e maiores coordenadas X e Y
	 * @return Retorna a consulta padrao de busca do logradouro
	 * @param p_BufferedImage Encapsula a imagem a ser gerada
	 ...
	 * @param p_PKLote Numero de lote ctm
	 */
                ...
                String geometria_lote,String lote_ctm_numero_do_lote)
	{
		...
		v_ConsultaLote += " from " + p_NomeTabelaLoteCtm + " l ";
                v_ConsultaLote += " where l.status_trabalho = 'OK' and l.tipo_fechamento = 'LOTE CTM'";
		v_ConsultaLote += " and l."+lote_ctm_numero_do_lote+" = '" + p_PKLote + "'";
