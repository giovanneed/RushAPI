...
<html>
    <head>
     ...
     font-family:verdana;
		...
		#mapa { height: 620px; width: 100%; margin: 0px; padding: 0px }
	...
	<script type="text/javascript">
                  ...
                  if (GBrowserIsCompatible()) {
                       ...
                       //geoXml = new GGeoXml("http://localhost:8084/eventos/teste.kml");
						...
						GEvent.addListener(<?echo "marker".$array['CodEstabelecimento']?>, "click", function() {
								<?echo "marker".$array['CodEstabelecimento']?>.openInfoWindowHtml("<div id='window' class='infowindow'><b>Nome:</b> <?echo $array['Nome']?> <br><input type='button' value='Ver Eventos' OnClick=enviaForm()><input type='button' value='Criar Eventos' OnClick=enviaForm2()><br></div>");
								document.getElementById('codigo').value= '<?echo $array['CodEstabelecimento']?>';								
								document.getElementById('codigo2').value= '<?echo $array['CodEstabelecimento']?>';								
	 ...
	 <div data-role="page" id="principal">
		...
		<form name="criaeventos" method="GET" action="criaEvento.php">
			<input type="hidden" id="codigo2" name="codigo" value="0">
		</form>			
              ...
              <div data-role="navbar">
                   <ul>
					...
					<li>
                        ...
                        <li>
                            <a href="#" id="chat" data-icon="grid" data-theme="a" class="ui-btn ui-btn-icon-top ui-btn-up-a"  data-transition="pop" OnClick=recarrega("Boate")>
                             <span class="ui-btn-text">Boate</span>

                            </a>
                        </li>
                        <li>
                            <a href="#" id="chat" data-icon="grid" data-theme="a" class="ui-btn ui-btn-icon-top ui-btn-up-a" OnClick=recarrega("Academico")>
                             <span class="ui-btn-text">Academico</span>
                            </a>
                        </li>
						<li>
                            <a href="#" id="chat" data-icon="grid" data-theme="a" class="ui-btn ui-btn-icon-top ui-btn-up-a" OnClick=recarrega("all")>
                             <span class="ui-btn-text">Todos</span>
                            </a>
                        </li>
						  <li>
                            <a href="#sobre" id="chat" data-icon="home" data-theme="a" class="ui-btn ui-btn-icon-top ui-btn-up-a" >
