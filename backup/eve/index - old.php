...
$query = mysql_query("SELECT * FROM locais ORDER BY nome") or die(mysql_error());
 
//faz um looping e cria um array com os campos da consulta
while($array = mysql_fetch_array($query))
{
  //mostra na tela o nome e a data de nascimento
  echo $array['cod']." ".$array['nome']." ".$array['lat']." ".$array['lon']." ".$array['descricao']."<br />";
  $nome = $array['nome'];
  $lat = $array['lat'];
  $lon = $array['lon'];
                  ...
                  if (GBrowserIsCompatible()) {
                       ...
                       geoXml = new GGeoXml("http://localhost:8084/eventos/teste.kml");
						...
						GEvent.addListener(marker, "click", function() {
								marker.openInfoWindowHtml("Marker <b><?echo $descricao?></b>");
								});
