...
$query = mysql_query("SELECT * FROM TabEvento") or die(mysql_error());
while($array = mysql_fetch_array($query)){
					
					    echo "<br>";
						echo "codEvento	:".$array['codEvento'];
						echo "<br>";
					    echo "codEstabelecimento	:".$array['codEstabelecimento'];
						echo "<br>";
						echo "data	:".$array['data'];
						echo "<br>";
						echo "descricao	:".$array['descricao'];
						echo "<br>";
						echo "confirmados	:".$array['confirmados'];
						echo "<br>";
						echo "-------------------------";
						echo "<br>";
}
